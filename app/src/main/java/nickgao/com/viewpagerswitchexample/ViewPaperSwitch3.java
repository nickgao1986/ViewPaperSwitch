...
import nickgao.com.viewpagerswitchexample.view.CardTransformer2;
import nickgao.com.viewpagerswitchexample.view.OrientedViewPager;

public class ViewPaperSwitch3 extends AppCompatActivity {
    ...
    public static void startActivity(Context context) {
        ...
        intent.setClass(context,ViewPaperSwitch3.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = (OrientedViewPager) findViewById(R.id.viewpager);
        new MyTask().execute();
    ...
    private void setAdapter() {
        ...
        CardTransformer2 mCardPageTransformer = new CardTransformer2();
        //设置limit
